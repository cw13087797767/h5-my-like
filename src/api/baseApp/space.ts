...
// 新增日记
export const spaceInsert = (params:any) => Http.axiosHttpPostForm(`/mylike/api/baseApp/space/insert`,params)

// 日记列表
export const spaceList = (params:any) => Http.axiosHttpGet(`/mylike/api/baseApp/space/list?pageSize=10&pageNum=${params}`)

// 日记详情
export const spaceDetail = (params:any) => Http.axiosHttpGet(`/mylike/api/baseApp/space/detail?id=${params}`)
